...
class XMLElement
	...
	public:
		...
		HRESULT XMLElement::Sign(vector<PCCERT_CONTEXT> cert,const wchar_t* algo = L"SHA256",const LPCWSTR sl = L"/Signature");
		string XMLElement::Encrypt(const char* d, ULONG l);
#endif
